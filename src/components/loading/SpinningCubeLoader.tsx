...
export default function SpinningCubeLoader() {
  ...
  useAnimationFrame((t) => {
    ...
    // Giảm biên độ nhảy từ 50 xuống 25 để không tràn lên trên
  ...
  return (
    <style>{`
      .loader-wrapper {
        ...
        align-items: center;
        padding: 12px 0; /* nhẹ hơn 1 chút */
      }

      /* Giảm kích thước từ 200 xuống 140 */
      .container {
        perspective: 800px;
        width: 140px;
        height: 140px;
      ...
      /* translateZ = 1/2 cube size => 70px thay vì 100px */
      .front {

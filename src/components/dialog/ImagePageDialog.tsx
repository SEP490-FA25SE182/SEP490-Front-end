    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent>
          ...
          <div className="border border-gray-200 rounded p-3 bg-gray-50">
            ...
            {selectedIllustrationId ? (
              <div className="flex items-center justify-center">
                <img src={gsToHttp(illustrationsList.find(i => i.id === selectedIllustrationId)?.url || "")} alt="Preview" className="max-h-[60vh] object-contain rounded" />
              </div>
            ) : (
        ...
        <DialogFooter className="mt-4 flex justify-end gap-2">
          ...
          <Button variant="outline" onClick={() => setOpenMarkerDialog(true)}>
            Thêm AR (marker)
          </Button>
